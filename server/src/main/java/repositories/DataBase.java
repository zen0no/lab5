...
public class DataBase extends LinkedHashMap<String, HumanBeing> implements Repository<HumanBeing> {
    ...
    private List<HumanBeing> removeEntity(List<HumanBeing> entityList){
    ...
    @Override
    public List<HumanBeing> removeEntity(Specification<HumanBeing> specification){
        return removeEntity(query(specification));
    }

    @Override
    public List<HumanBeing> removeEntity(){
        return removeEntity(query());
    }
